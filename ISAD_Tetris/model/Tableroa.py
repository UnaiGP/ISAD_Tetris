...
class Tableroa:
    def __init__(self, tamaina,zailtasun):
        self.tamaina = tamaina
        self.hasieratu_tableroa()
        self.zailtasun=zailtasun
    ...
    def mugitu_behera(self,x):
        ...
        if x==1:
            ...
            posizio_berria = (self.posizioa[0] + 2, self.posizioa[1])
            if self.probatu_mugimendua(posizio_berria):
                self.posizioa = posizio_berria
            else:
                posizio_berria = (self.posizioa[0] + 1, self.posizioa[1])
            ...
            posizio_berria = (self.posizioa[0] + 3, self.posizioa[1])
            if self.probatu_mugimendua(posizio_berria):
                self.posizioa = posizio_berria
            else:
                posizio_berria = (self.posizioa[0] + 2, self.posizioa[1])
    ...
    def betetako_lerroak_ezabatu(self):
        ...
        if self.zailtasun==1:
            if count == 1:
                ...
                self.puntuazioa += 800
        elif self.zailtasun==2:
            if count == 1:
                self.puntuazioa += 200
            elif count == 2:
                self.puntuazioa += 600
            elif count == 3:
                self.puntuazioa += 1000
            elif count == 4:
                self.puntuazioa += 1600
        else:
            if count == 1:
                self.puntuazioa += 300
            elif count == 2:
