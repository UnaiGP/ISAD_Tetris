    ...
    def __init__(self,erab):
        ...
        def datuakGorde():
            ...
            or options5.get() == "Aukeratu" or options6.get() == "Aukeratu" or options7.get() == "Aukeratu" or options8.get() == "Aukeratu"):
                ...
                showinfo(title="ONDO", message="Pertsonalizazioa gorde da, atzera eman aldaketak egiteko")
        ...
        bakgroundKolorea.grid(row=1, column=1, padx= 20)
        ...
        soinuAukera.grid(row=2, column=1, padx= 20)
        ...
        laukiaKolorea.grid(row=3, column=1, padx= 20)
        ...
        ilaraKolorea.grid(row=4, column=1, padx= 20)
        ...
        lKolorea.grid(row=5, column=1, padx= 20)
        ...
        lIspiluKolorea.grid(row=6, column=1, padx= 20)
        ...
        zKolorea.grid(row=7, column=1, padx= 20)
        ...
        zIspiluKolorea.grid(row=8, column=1, padx= 20)
