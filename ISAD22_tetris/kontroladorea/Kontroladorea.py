...
class Kontroladorea(object):
    ...
    def erabiltzaileakPrintatu(self):
        return DatuBase().erabiltzaileakPrintatu()
    ...
    def gordePartida(self,tab,erab): #es de la DB?
        return DatuBase().gordePartida(tab, erab)

    def kargatuPartida(self,zailtasuna,erab):
        return DatuBase().kargatuPartida(zailtasuna)
