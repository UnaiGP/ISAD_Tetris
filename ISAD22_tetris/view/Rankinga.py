...
from ISAD22_tetris.model.Tableroa import Tableroa
...
class Rankinga(object):
    def __init__(self, mota, erab):
        ...
        if mota==2:
            ...
            erabiltzaile1 = DatuBase.DatuBase.erabiltzaieakPrinteatu(self,punt10)
            erabiltzaile2 = DatuBase.DatuBase.erabiltzaieakPrinteatu(self,punt9)
            erabiltzaile3 = DatuBase.DatuBase.erabiltzaieakPrinteatu(self,punt8)
            erabiltzaile4 = DatuBase.DatuBase.erabiltzaieakPrinteatu(self,punt7)
            erabiltzaile5 = DatuBase.DatuBase.erabiltzaieakPrinteatu(self,punt6)
            erabiltzaile6 = DatuBase.DatuBase.erabiltzaieakPrinteatu(self,punt5)
            erabiltzaile7 = DatuBase.DatuBase.erabiltzaieakPrinteatu(self,punt4)
            erabiltzaile8 = DatuBase.DatuBase.erabiltzaieakPrinteatu(self,punt3)
            erabiltzaile9 = DatuBase.DatuBase.erabiltzaieakPrinteatu(self,punt2)
            erabiltzaile10 = DatuBase.DatuBase.erabiltzaieakPrinteatu(self,punt1)
        elif mota==4:
